...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    if (provider_id === req.userId) {
      return res
        .status(401)
        .json("Providers can't create appointments for yourself.");
    }
  ...
  async delete(req, res) {
    ...
    // verificação se é o dono do appointment para poder cancelar
    ...
    // verificação para permitir cancelamento apenas 2h antes
